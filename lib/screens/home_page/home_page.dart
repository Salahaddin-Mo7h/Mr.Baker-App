...
import 'package:mr.baker_application/screens/home_page/components/header.dart';
import 'package:mr.baker_application/screens/home_page/components/iconandtext.dart';
import 'package:mr.baker_application/widgets/appicons.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget productList() {
    return GetBuilder<RecommendedProductController>(
      builder: (values) => ListView.builder(

          physics: const BouncingScrollPhysics(),
          itemCount: values.RecommendedProductListData.length,
          shrinkWrap: true,
          itemBuilder: (context, index) => GestureDetector(
                onTap: () {
                  var product = Get.find<RecommendedProductController>()
                      .RecommendedProductListData[index];
                  Get.find<PopularProductController>().setInitQuantity(
                      product, Get.find<CartProductController>());
